...
class Configuration implements ConfigurationInterface
{
  ...
  public function getConfigTreeBuilder( )
  {
    ...
    $rootNode->children( ) // childrens
        ...
        ->scalarNode( 'lastname2' )->defaultValue( 'setLastname2' )->addDefaultsIfNotSet()->end( ) // last name 2
        ...
        ->scalarNode( 'photo' )->defaultValue( 'setPhoto' )->addDefaultsIfNotSet()->end( ) // photo
        ->end( )->end( ) // end array
